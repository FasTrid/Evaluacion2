...
public class Secundaria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstOperaciones.add((Button) findViewById(R.id.btnP1));
        lstOperaciones.add((Button) findViewById(R.id.btnP2));
        lstOperaciones.add((Button) findViewById(R.id.btnP));
